  ...
  return (
    <div className="allContents">
      ...
      <div>
        ...
        <h3 className="briefDescription">Senior Software Engineer at <a className="databricks" href="https://www.databricks.com" target="_blank">Databricks</a> </h3>
      </div>
